...
function [names,Table1,foldChange1,fluorescence_light,foldChange3_notaveraged,lightCVNew,darkCVNew,fluorescence_dark,fileNew]=CRAnalysisFunction(excelFileName)

%excelFileName=input('What is data file name? (make sure to include .xlsx) ','s');
[allData,tex]=xlsread('Excel Files/CRAnalysis.xlsx',excelFileName);
...
Light_dark=tex(:,2); % use strcmp(text,'dark') to search
...
%    
    JY145_light_overall_average=mCherryMedian(JY145_ind==1 & lightIndices==1);
    ...
    JY145_dark_overall_average=mCherryMedian(JY145_ind==1 & lightIndices~=1);
...
for k=1:length(listOfDates)
    ...
    ind_Date_p2_light=find(Date==listOfDates(k) & plateNumber==2 & lightIndices==1);
    mCherryMedian(ind_Date_p2_light)=mCherryMedian(ind_Date_p2_light)-Y11_Date_average;
    JY145_Date_p2_light=mCherryMedian(Date==listOfDates(k) & plateNumber==2 & lightIndices==1 & JY145_ind==1);
    ...
    ind_Date_p2_dark=find(Date==listOfDates(k) & plateNumber==2 & lightIndices~=1);
    mCherryMedian(ind_Date_p2_dark)=mCherryMedian(ind_Date_p2_dark)-Y11_Date_average;
    JY145_Date_p2_dark=mCherryMedian(Date==listOfDates(k) & plateNumber==2 & lightIndices~=1 & JY145_ind==1);
    ...
    ind_Date_p3_light=find(Date==listOfDates(k) & plateNumber==3 & lightIndices==1);
    mCherryMedian(ind_Date_p3_light)=(mCherryMedian(ind_Date_p3_light)-Y11_Date_average);
    JY145_Date_p3_light=mCherryMedian(Date==listOfDates(k) & plateNumber==3 & lightIndices==1 & JY145_ind==1);
    ...
    ind_Date_p3_dark=find(Date==listOfDates(k) & plateNumber==3 & lightIndices~=1);
    mCherryMedian(ind_Date_p3_dark)=(mCherryMedian(ind_Date_p3_dark)-Y11_Date_average);
    JY145_Date_p3_dark=mCherryMedian(Date==listOfDates(k) & plateNumber==3 & lightIndices~=1 & JY145_ind==1);
    ...
    ind_Date_p31_light=find(Date==listOfDates(k) & plateNumber==3.1 & lightIndices==1);
    mCherryMedian(ind_Date_p31_light)=(mCherryMedian(ind_Date_p31_light)-Y11_Date_average);
    JY145_Date_p31_light=mCherryMedian(Date==listOfDates(k) & plateNumber==3.1 & lightIndices==1 & JY145_ind==1);
    JY145_Date_p31_light(isoutlier(JY145_Date_p31_light))=NaN;
    JY145_Date_p31_light=nanmean(JY145_Date_p31_light);
    mCherryMedian(ind_Date_p31_light)=(mCherryMedian(ind_Date_p31_light))./JY145_Date_p31_light.*JY145_light_overall_average;
    
    ind_Date_p31_dark=find(Date==listOfDates(k) & plateNumber==3.1 & lightIndices~=1);
    mCherryMedian(ind_Date_p31_dark)=(mCherryMedian(ind_Date_p31_dark)-Y11_Date_average);
    JY145_Date_p31_dark=mCherryMedian(Date==listOfDates(k) & plateNumber==3.1 & lightIndices~=1 & JY145_ind==1);
    JY145_Date_p31_dark(isoutlier(JY145_Date_p31_dark))=NaN;
    JY145_Date_p31_dark=nanmean(JY145_Date_p31_dark);
    mCherryMedian(ind_Date_p31_dark)=(mCherryMedian(ind_Date_p31_dark))./JY145_Date_p31_dark.*JY145_dark_overall_average;
